...
class BookControllerTest {
	...
	void testGetBook() throws Exception {
		...
		ResultActions response = mockMvc.perform(get("/book/1")).andDo(MockMvcResultHandlers.print()); // this will
																										// print object
	...
	void testGetAllBooks() throws Exception {
		...
		ResultActions response = mockMvc.perform(get("/book")).andDo(MockMvcResultHandlers.print()); // this will print
																										// object
		...
		response.andExpect(MockMvcResultMatchers.status().isOk())
				...
				.andExpect(
						MockMvcResultMatchers.jsonPath("$[0].bookName", CoreMatchers.is(bookList.get(0).getBookName())))
				.andExpect(MockMvcResultMatchers.jsonPath("$[1].bookId", CoreMatchers.is(bookList.get(1).getBookId())))
				.andExpect(MockMvcResultMatchers.jsonPath("$[1].bookName",
						CoreMatchers.is(bookList.get(1).getBookName())));
	...
	void testSaveBook() throws Exception {
		...
		ResultActions response = mockMvc.perform(
				post("/book").contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(book)))
	...
	void testUpdateBook() throws JsonProcessingException, Exception {
		...
		ResultActions response = mockMvc.perform(
				put("/book").contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(book)))
				.andDo(MockMvcResultHandlers.print()); // this will print object
	...
	void testDeleteBook() throws Exception {
		...
		ResultActions response = mockMvc.perform(delete("/book/1")).andDo(MockMvcResultHandlers.print()); // this will
		// print object
